...
- ~45-60 minute round
- Mix of **visual/architectural discussion** (80%) + **code** (20%)
- You'll usually **draw/whiteboard** (or use a Figma/Excalidraw-style tool)
- Code is optional unless they specifically ask for it; when they do, it's usually pseudocode or high-level structure, not production code
- They care more about *how you think* than pixel-perfect implementations
